...
helm uninstall -n argocd devops
helm uninstall -n istio-system jaeger-operator
helm uninstall -n istio-system kiali-operator
helm uninstall -n kubesphere-system ks-core
helm uninstall -n kubesphere-logging-system ks-events
helm uninstall -n kubesphere-system ks-installer
helm uninstall -n kubesphere-system ks-minio
helm uninstall -n kubesphere-system ks-openldap
helm uninstall -n kubesphere-logging-system kube-auditing
helm uninstall -n kubesphere-logging-system logsidecar-injector
helm uninstall -n kubesphere-monitoring-system notification-manager
helm uninstall -n kubesphere-logging-system opensearch-dashboard
helm uninstall -n kubesphere-logging-system opensearch-data
helm uninstall -n kubesphere-logging-system opensearch-logging-curator
helm uninstall -n kubesphere-logging-system opensearch-master
